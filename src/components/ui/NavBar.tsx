...
export const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50">
      ...
      >
        <div className="hidden sm:flex max-w-7xl mx-auto px-9 sm:px-20 lg:px-20 border-b border-neutral-200/50 dark:border-neutral-800/50 justify-between items-center py-2">
      ...
      >
        <nav
          className={`flex items-center justify-between max-w-7xl mx-auto transition-all duration-300 ease-in-out
            ${
              isScrolled
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              className="lg:hidden mt-2 max-w-7xl mx-auto bg-white/95 dark:bg-black/95 backdrop-blur-lg shadow-lg rounded-3xl"
            >
